...
export default function AdminOverviewPanel() {
  ...
  const stats = useMemo(() => {
    ...
    const activeTechnicians = new Set(
      tickets
        .filter((t) => t.status === "IN_PROGRESS" && t.assigneeName)
    ...
    <div className="space-y-6">
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl px-6 py-3 flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-red-600 font-medium text-sm">
              {stats.slaBreachesList.length} critical ticket(s) have breached
              their 2h SLA deadline
            </span>
          </div>
          <button
        ...
        <div className="border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              The most recent five tickets sorted by creation date.
            </p>
          </div>
          <Link
      ...
      <style jsx global>{`
        @keyframes criticalTicketPulse {
          ...
          50% {
            box-shadow:
              inset 4px 0 0 0 #ff4d4f,
              0 0 0 0 rgba(255, 77, 79, 0.3);
          }
        }
        .critical-ticket-row {
