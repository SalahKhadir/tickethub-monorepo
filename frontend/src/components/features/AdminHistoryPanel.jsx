    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Review historical ticket resolution performance by category
        </p>
      </div>
      ...
      {categories.length === 0 ? (
        ...
        <div className="space-y-4">
          {categories.map((cat) => {
            ...
            const avgHours =
              validTimes > 0 ? Math.floor(totalTime / validTimes / 3600000) : 0;
            const avgMins =
              validTimes > 0
                ? Math.floor(((totalTime / validTimes) % 3600000) / 60000)
                : 0;
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-gray-500 mt-1 flex items-center gap-2">
                      ...
                      <span>
                        Avg resolution: {avgHours}h {avgMins}m
                      </span>
                    </p>
                  </div>
                                ...
                                >
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center gap-1.5">
                                      ...
                                      {res.breached && (
                                        <span className="ml-1.5 px-1.5 py-0.5 rounded text-[10px] font-bold bg-red-100 text-red-600 tracking-wide border border-red-200">
                                          SLA BREACH
                                        </span>
                                      )}
                                    </div>
