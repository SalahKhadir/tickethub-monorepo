...
export default function TicketForm() {
  ...
  const inputClasses =
    "w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 transition-colors focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 hover:border-gray-300 shadow-sm";
  return (
